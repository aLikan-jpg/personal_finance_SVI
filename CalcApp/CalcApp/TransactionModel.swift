...
extension Category {
    ...
    static let feesAndCharge = Category(id: 4, name: "Fees & Charge", icon: .hand_holding_usd)
    static let foodAndDining = Category(id: 5, name: "Food & Dining", icon: .hamburger)
    static let home = Category(id: 6, name: "Home", icon: .film)
    ...
    static let restaraunts = Category(id: 502, name: "Restaraunts", icon: .utensils, mainCategoryId: 5)
